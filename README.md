...
**Мост в Codex через VK.** Продолжайте существующие задачи десктопного Codex с телефона: выбирайте задачу в менеджерском диалоге, открывайте связанную VK-беседу и отправляйте уточнения в тот же контекст.
